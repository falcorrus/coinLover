...
**Project:** CoinLover Organic Mint
**Generated:** 2026-03-23 18:39:08
...
|------|-----|--------------|
| Primary | `#924A28` | `--primary-color` |
| Accent/Highlight | `#CA8A04` | `--glass-border-highlight` |
| Background | `#E8F0ED` | `--bg-color` |
| Card/Item Bg | `#F3FBF8` | `--glass-card-bg` |
| Text Main | `#161D1C` | `--text-main` |

**Color Notes:** Organic Mint background + Copper trust + Harvest Gold highlights.

### Interaction (Target Glow)

- **Scale:** `1.2` (for distinct visual feedback)
- **Shadow:** `var(--soft-ui-outset)` + subtle copper glow (`rgba(146, 74, 40, 0.2)`)
- **Background Tint:** `#924A2815` (15% opacity copper tint)
- **Transition:** 250ms spring-like bezier (`cubic-bezier(0.34, 1.56, 0.64, 1)`)
