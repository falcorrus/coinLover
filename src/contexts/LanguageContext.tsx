...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'Russian': 'Русский',
    'Update': 'Обновить',
    'Reconcile Balances': 'Пересчитать',
    'Reconciliation': 'Сверка балансов',
    'Ignore Discrepancy': 'Оставить текущий (скрыть расхождение)',
    'Reset Ignored': 'Сбросить скрытые',
    'Ignored Discrepancies': 'Скрыто расхождений',
    'Feed': 'Лента',
    'Calendar': 'Календарь',
    'Analytics': 'Аналитика',
    ...
    'Are you sure you want to log out?': 'Вы уверены, что хотите выйти? Локальные данные этой сессии будут очищены.',
    'Back': 'Назад',
    ...
    'Earned today': 'Сегодня записано доходов на сумму',
  ...
  en: {
    ...
    'Russian': 'Russian',
    'Update': 'Update',
    'Reconcile Balances': 'Recalculate',
    'Reconciliation': 'Reconciliation',
    'Ignore Discrepancy': 'Keep current (dismiss discrepancy)',
    'Reset Ignored': 'Reset ignored',
    'Ignored Discrepancies': 'Ignored discrepancies',
    'Feed': 'Feed',
    'Calendar': 'Calendar',
    'Analytics': 'Analytics',
    'Security': 'Security',
    'Application': 'App',
    'Logout': 'Log out',
    'Are you sure you want to log out?': 'Are you sure you want to log out? Local data for this session will be cleared.',
    'Back': 'Back',
