...
export function AccountsSection({
  ...
  return (
    <section className="px-0 pt-4 pb-2 relative z-20 shrink-0">
      ...
      <SortableContext items={accounts.map(a => a.id)} strategy={horizontalListSortingStrategy}>
        <div className="flex gap-4 overflow-x-auto hide-scrollbar px-6 pb-2 pt-1">
          {accounts.map(acc => (
            <AccountItem 
          ...
          <div
            ...
            className="flex flex-col items-center gap-2 justify-start transition-all duration-300 w-[76px] shrink-0 cursor-pointer opacity-60 hover:opacity-100 hover:scale-105 active:scale-95 group"
          >
