...
export const AccountItem: React.FC<Props> = ({
  ...
  return (
    <div
      ...
      className={`flex flex-col items-center gap-2 justify-start transition-all duration-300 w-[84px] shrink-0 cursor-pointer ${isDragging ? "opacity-30" : "opacity-100"} ${(isSortingMode && (isDragging || isPressing)) ? 'animate-wiggle' : ''}`}
      onClick={() => {
