...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-[650vh] bg-[#050505] text-white selection:bg-[#6d5dfc]/30 font-sans overflow-x-hidden focus:outline-none">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-4 md:px-6 py-4 md:py-6 backdrop-blur-md border-b border-white/5 pt-[calc(1rem+env(safe-area-inset-top,0px))] md:pt-[calc(1.5rem+env(safe-area-inset-top,0px))]">
